...
- Modal does not support any handler, inner, wrapper zapclasses
...
- Zap plugin now have its own entry point
...
- zapClass now support chip-remove

## Beta version 0.0.32 Updates

- zapClass now support chip-icon

## Beta version 0.0.31 Updates

- zapClass now support chip-text
