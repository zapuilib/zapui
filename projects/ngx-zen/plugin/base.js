...
module.exports = plugin(function ({ addVariant, e }) {
  const variants = [
    ...
    { name: "dialog-title", targetElement: ".__ngx__zen__dialog__title" },
    { name: "dialog-handler", targetElement: ".__ngx__zen__dialog__handler" },
    { name: "dialog-separator", targetElement: ".__ngx__zen__dialog__separator" },
    { name: "dialog-content", targetElement: ".__ngx__zen__dialog__content p" },
    { name: "dialog-btn-primary", targetElement: ".__ngx__zen__dialog__footer .primary" },
    { name: "dialog-btn-secondary", targetElement: ".__ngx__zen__dialog__footer .secondary" },
