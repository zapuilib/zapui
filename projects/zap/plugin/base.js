...
module.exports = plugin(function ({ addVariant, e }) {
  const variants = [
    ...
    { name: "dialog-handler", targetElement: ".__ngx__zap__dialog__handler" },
    { name: "dialog-separator", targetElement: ".__ngx__zap__dialog__separator" },
    ...
    { name: "dialog-btn-secondary", targetElement: ".__ngx__zap__dialog__footer .secondary" },
